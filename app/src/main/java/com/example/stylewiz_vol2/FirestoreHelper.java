...
public class FirestoreHelper {
    ...
    private void addWardrobeItem(String userId, String category, String styleTag, String description, String color, String season, boolean liked, String photoUrl) {
        ...
        wardrobeItem.put("photoUrl", photoUrl);

        wardrobeRef.add(wardrobeItem)
                .addOnSuccessListener(documentReference -> System.out.println("Wardrobe item added with ID: " + documentReference.getId()))
                .addOnFailureListener(e -> System.err.println("Error adding wardrobe item: " + e.getMessage()));
    }
    ...
    // Callback interface for getting the item data
